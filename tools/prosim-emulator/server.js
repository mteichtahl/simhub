    ...
    function (a) {
      var data = {
        'data': {
          'ts': moment.utc(),
          'sts': moment.utc(),
          'pitch': randomFloat(-180, 180),
          'roll': randomFloat(-180, 180),
          'yaw': randomFloat(-180, 180),
          'vspeed': faker.random.number(499),
          'success': faker.random.boolean(),
          'latitude': faker.address.latitude(),
          'longitude': faker.address.longitude(),
          'airspeed': randomFloat(350),
          'heading': randomFloat(0, 359),
          'altitude': faker.random.number,
          'weather': {
            'heading': randomFloat(0, 359),
            'speed': randomFloat(350)
          },
          'turbulance': faker.random.number(255)
        }
      }
